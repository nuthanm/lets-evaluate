...
-- Add previous_screening_id for linking to reused analyses
ALTER TABLE screenings ADD COLUMN previous_screening_id text REFERENCES screenings(id) ON DELETE SET NULL;
